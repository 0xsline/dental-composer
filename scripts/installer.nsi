...
Name "牙片拼图"
Caption "牙片拼图 安装"
OutFile "DentalComposer-0.1.6-Win7-x64-setup.exe"
...
continueinstall:
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\DentalComposer" "DisplayVersion" "0.1.6"
